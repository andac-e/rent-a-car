...
public class BrandManager implements BrandService {
    ...
    public List<GetAllBrandResponse> getAll() {
        ...
        List<GetAllBrandResponse> result = brands.stream().map(brand -> this.modelMapperService.forResponse().map(brand, GetAllBrandResponse.class)).collect(Collectors.toList());
        return result;
    }
}
